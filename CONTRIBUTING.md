Contributing to LeedCoin Core
============================

The LeedCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/leedcoin-project/leedcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LeedCoin Core project, and is not to be
confused with overall LeedCoin Network Protocol consensus changes.

Whether a pull request is merged into LeedCoin Core rests with the project merge
...
Patches that change LeedCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the LeedCoin consensus, it must have been
...
The project leader is the release manager for each LeedCoin Core release.
