...
/** Utility functions used by the LeedCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LeedCoin addresses in monospace font
...
// Parse "leedcoin:" URI into recipient object, return true on successful parsing
