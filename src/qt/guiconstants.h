...
/* LeedCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LeedCoin"
#define QAPP_ORG_DOMAIN "leedcoin.org"
#define QAPP_APP_NAME_DEFAULT "LeedCoin-Qt"
#define QAPP_APP_NAME_TESTNET "LeedCoin-Qt-testnet"
