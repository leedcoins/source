...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LeedCoin Core"),
     ...
     * override -datadir in the leedcoin.conf file in the default data directory
     * (to be consistent with leedcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
