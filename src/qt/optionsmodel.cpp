...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::LDC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeLeedCoinAmount"))
        SoftSetArg("-anonymizeleedcoinamount", settings.value("nAnonymizeLeedCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in leedcoin.cpp during shotdown to also remove the window positions
