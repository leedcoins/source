                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLDCPathCustom = GetArg("-zldcbackuppath", "");
    ...
    if(!strzLDCPathCustom.empty()) {
        ui->wallet_customzldcbackuppath->setText(QString::fromStdString(strzLDCPathCustom));
        ui->wallet_customzldcbackuppath_label->setVisible(true);
        ui->wallet_customzldcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLDCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LeedCoin RPC console.") + "<br>" +
