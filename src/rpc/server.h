...
/**
 * LeedCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZldcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzldcseed(const UniValue& params, bool fHelp);
extern UniValue getzldcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzldc(const UniValue& params, bool fHelp);
extern UniValue dzldcstate(const UniValue& params, bool fHelp);
