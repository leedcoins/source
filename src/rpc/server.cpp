...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop LeedCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "LeedCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LeedCoin features */
        {"leedcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"leedcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"leedcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"leedcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"leedcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"leedcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"leedcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"leedcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"leedcoin", "startmasternode", &startmasternode, true, true, false},
        {"leedcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"leedcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"leedcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"leedcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"leedcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"leedcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"leedcoin", "preparebudget", &preparebudget, true, true, false},
        {"leedcoin", "submitbudget", &submitbudget, true, true, false},
        {"leedcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"leedcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"leedcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"leedcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"leedcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"leedcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"leedcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"leedcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"leedcoin", "mnsync", &mnsync, true, true, false},
        {"leedcoin", "spork", &spork, true, true, false},
        {"leedcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzldcseed", &getzldcseed, false, false, true},
        {"zerocoin", "setzldcseed", &setzldcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzldc", &searchdzldc, false, false, true},
        {"zerocoin", "dzldcstate", &dzldcstate, false, false, true},
...
{
    return "> leedcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13193/\n";
}
