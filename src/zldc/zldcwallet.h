...
#ifndef LeedCoin_ZLDCWALLET_H
#define LeedCoin_ZLDCWALLET_H
...
public:
    CzLDCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLDC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLDC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
