...
#ifndef LeedCoin_ZLDCTRACKER_H
#define LeedCoin_ZLDCTRACKER_H
...
public:
    CzLDCTracker(std::string strWalletFile);
    ~CzLDCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLDCWallet* zLDCWallet = NULL);
