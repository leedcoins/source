...
/** 
    ...
    ****Note - for LeedCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of leedcoin coming in to a transaction
