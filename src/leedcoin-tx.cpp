...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LeedCoin Core leedcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  leedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded leedcoin transaction") + "\n" +
                               "  leedcoin-tx [options] -create [commands]   " + _("Create hex-encoded leedcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded leedcoin transaction
