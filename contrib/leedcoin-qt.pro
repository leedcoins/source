...
RESOURCES += src/qt/leedcoin.qrc src/qt/leedcoin_locale.qrc

TRANSLATIONS += src/qt/locale/leedcoin_bg.ts \
                src/qt/locale/leedcoin_de.ts \
                src/qt/locale/leedcoin_en.ts \
                src/qt/locale/leedcoin_es.ts \
                src/qt/locale/leedcoin_fi.ts \
                src/qt/locale/leedcoin_fr.ts \
                src/qt/locale/leedcoin_it.ts \
                src/qt/locale/leedcoin_ja.ts \
                src/qt/locale/leedcoin_pl.ts \
                src/qt/locale/leedcoin_pt.ts \
                src/qt/locale/leedcoin_ru.ts \
                src/qt/locale/leedcoin_sk.ts \
                src/qt/locale/leedcoin_sv.ts \
                src/qt/locale/leedcoin_vi.ts \
                src/qt/locale/leedcoin_zh_CN.ts \
                src/qt/locale/leedcoin_zh_TW.ts
